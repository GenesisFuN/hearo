#!/bin/bash
# Quick installer script for Coqui TTS Server on Runpod

cat > coqui-server-production.py << 'ENDOFFILE'
"""
...
echo "Now run: uvicorn coqui-server-production:app --host 0.0.0.0 --port 8000"
